...
class Ps_checkout7363AdminContainer extends Container
{
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.4.4', 'C:\\xampp\\htdocs\\prestashop_1.7.4.4', true);
    }
