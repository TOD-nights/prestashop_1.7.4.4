...
<div class="form-group row">
    <label class="form-control-label">
        {l s='Generate description or meta description' mod='bonaicontent'}
    </label>
    <div class="col-sm row">
        <div class="bonaicontent-form-inner col-12 col-xs-12 col-lg-6 mb-3">
            <select id="bonaicontent_content_type" class="custom-select mb-3">
                <option value="categoryDescription">{l s='Description' mod='bonaicontent'}</option>
                <option value="categoryMetaDescription" selected="selected">{l s='Meta Description' mod='bonaicontent'}
                </option>
            </select>

            <input type="hidden" id="category_id" name="category_id" value="{$category_id|escape:'htmlall':'UTF-8'}" />
        ...
        <div id="bonai_popup" class="col-12 col-xs-12 col-lg-6 mb-3"></div>
    </div>
</div>